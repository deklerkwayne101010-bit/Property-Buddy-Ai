      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-32">
          ...
          >
            ...
            >
              Empowering real estate professionals with cutting-edge AI technology to create stunning property listings and marketing materials.
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <p className="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
            At Stagefy, we believe that every property deserves to be showcased in the best possible light.
            Our AI-powered platform helps real estate professionals create professional, engaging property
            listings and marketing materials in minutes, not hours.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          >
            ...
            <p className="text-slate-600">
              Generate professional property descriptions, edit photos, and create marketing materials in minutes using advanced AI technology.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-slate-600">
              Our AI creates content that matches the quality and style of professional real estate marketing materials.
            </p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-4">Easy to Use</h3>
            <p className="text-slate-600">
              Intuitive interface designed specifically for real estate professionals. No technical expertise required.
            </p>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-slate-600">
                <p>
                  Stagefy was born from the frustration of real estate professionals spending hours creating
                  property descriptions and marketing materials. We saw an opportunity to leverage AI technology
                  to streamline this process.
                </p>
                <p>
                  Founded by a team of real estate experts and AI specialists, Stagefy combines deep industry
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-slate-600 text-sm">Constantly pushing the boundaries of AI technology for real estate.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-slate-600 text-sm">Delivering professional-grade results every time.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-slate-600 text-sm">Building a supportive community of real estate professionals.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-slate-600 text-sm">Your data and privacy are our top priorities.</p>
            </div>
          </div>
        </motion.div>
      </div>
