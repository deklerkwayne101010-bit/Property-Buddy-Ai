  ...
  try {
    ...
    const response = await fetch('https://api.replicate.com/v1/predictions', {
      ...
      body: JSON.stringify({
        ...
        input: {
          "top_p": 1,
          "prompt": "analyise this picture",
          "messages": [],
          "image_input": [imageUrl],
          "temperature": 1,
          "system_prompt": "ai video maker.",
          "presence_penalty": 0,
          "frequency_penalty": 0,
    ...
    if (!response.ok) {
      ...
      console.error('Replicate API Status:', response.status);
    ...
    if (prediction.status === 'succeeded') {
      ...
      console.log('Analysis succeeded:', analysis);
    ...
    console.error('Error in GPT-4o analysis:', error);
