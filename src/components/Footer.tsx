  ...
  const sitemapSections = {
    ...
    tools: {
      ...
      links: [
        ...
        { name: 'Template Editor', href: '/template-editor' },
        { name: 'Canva Integration', href: '/canva-upload' },
        { name: 'Bulk Generation', href: '/api/bulk-generate' },
        { name: 'Usage Analytics', href: '/account' }
      ]
    },
    account: {
      title: 'Account',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            >
              ...
              <span className="text-xl font-bold">Property Buddy AI</span>
            </motion.div>
            <p className="text-slate-400 text-sm mb-4">
              AI-powered tools for real estate professionals. Create stunning property listings with advanced artificial intelligence.
            </p>
          ...
          {/* Sitemap Sections */}
          {Object.entries(sitemapSections).map(([key, section], index) => (
            <motion.div
              key={key}
              className="space-y-4"
              initial={{ opacity: 0, y: 20 }}
        ...
        >
          <div className="text-slate-400 text-sm mb-4 md:mb-0">
            © {currentYear} Property Buddy AI. All rights reserved.
          </div>
