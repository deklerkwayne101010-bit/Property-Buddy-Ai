...
export const IconCrop: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M6 2v4h4"/><path d="M6 6H2v4"/><path d="M18 18h4v-4"/><path d="M18 14v4h-4"/><rect x="6" y="6" width="12" height="12" rx="2"/></svg>
);